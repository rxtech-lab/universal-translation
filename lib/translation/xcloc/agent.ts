...
async function* scanTerminology(params: {
	...
	const result = await generateText({
		...
		system: `You are a terminology extraction specialist for software localization.
...
- UI element names appearing in multiple strings
...
async function* translateBatch(params: {
	...
	const result = streamText({
		...
		system: `You are a professional translator for software localization.
